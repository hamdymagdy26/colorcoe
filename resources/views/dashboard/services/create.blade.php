    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Create Services</span>
                <span class="text-muted mt-1 fw-semibold fs-7">Create services with all types</span>
            </h3>
        ...
        <!--begin::Table container-->
            <form method="post" action="{{route('admin_services.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="mb-10">
