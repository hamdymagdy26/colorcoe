<div class="card-body p-0">
    ...
    <div class="form-group">
        ...
        <div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])" data-kt-initialized="1">
            ...
            <div class="col-6">
                <!--begin::Option-->
                <label class="form-check-image form-check-success {{ setting('layout.layout', 'dark-sidebar') === 'dark-sidebar' ? 'checked="checked"' : '' }}">
                    <!--begin::Image-->
                    <div class="form-check-wrapper">
                    ...
                    <div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
                        <input class="form-check-input" type="radio" checked="checked" value="dark-sidebar" name="layout-builder[layout]" {{ setting('layout.layout', 'dark-sidebar') === 'dark-sidebar' ? 'checked="checked"' : '' }}>
                        <!--begin::Label-->
            ...
            <div class="col-6">
                <!--begin::Option-->
                <label class="form-check-image form-check-success" {{ setting('layout.layout') === 'light-sidebar' ? 'checked="checked"' : '' }}>
                    <!--begin::Image-->
                    <div class="form-check-wrapper">
                    ...
                    <!--begin::Check-->
                    <div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
                        <input class="form-check-input" type="radio" value="light-sidebar" name="layout-builder[layout]" {{ setting('layout.layout') === 'light-sidebar' ? 'checked="checked"' : '' }}>
                        <!--begin::Label-->
